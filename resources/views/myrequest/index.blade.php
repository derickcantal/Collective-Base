<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <a href="{{ route('mycabinet.index') }}"> Cabinet</a> | <a href="{{ route('myrental.index') }}"> Rental </a> | <u><a href="{{ route('myrequest.index') }}"> Request</a></u>
        </h2>
    </x-slot>
    <section>
        <div class="py-8">
                                        ...
                                        <tbody>
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                <td class="px-6 py-4">
                                                    ...
                                                    | <a class="font-medium text-green-600 dark:text-green-500 hover:underline" href="{{ route('myrequest.sales',$cabinet->cabid) }}">Sales</a>
                                                </td>
                                            </tr>
