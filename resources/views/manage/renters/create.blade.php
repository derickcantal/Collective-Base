                        ...
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-2 sm:col-span-1 p-4">
                                <div class="form-group">
                                    ...
                                    <x-text-input id="branchname" class="block mt-1 w-full" type="text" name="branchname" :value="old('branchname',$branch->branchname)" readonly required/>
