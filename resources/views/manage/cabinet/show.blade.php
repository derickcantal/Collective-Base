            ...
            <div class="py-8 max-w-screen-2xl mx-auto sm:px-6 lg:px-8">
                ...
                <nav class="flex px-5 py-3 text-gray-700 bg-white dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">
                                Cabinet No. {{ $cabinets->cabinetname }}</span>
                        </div>
                        </li>
                    </ol>
                </nav>
                ...
                <div class="relative bg-white rounded-lg dark:bg-gray-800">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2 sm:col-span-1 p-4 ">
                            <div class="form-group">
                                <x-input-label for="cabid" :value="__('Branch')" />
                        ...
                        <div class="col-span-2 sm:col-span-1 p-4">
                            <div class="form-group">
                                <x-input-label for="branchname" :value="__('Cabinet Price')" />
                                <h5 class="text-lg font-semibold text-gray-900 dark:text-white">
                                    {{ $cabinets->cabinetprice }}
                                </h5>
                            </div>
                        </div>
                        <!-- middlename -->
                        <div class="col-span-2 sm:col-span-1 p-4">
                            <div class="form-group">
                                <x-input-label for="timerecorded" :value="__('Renter')" />
                                <h5 class="text-lg font-semibold text-gray-900 dark:text-white">
                                    {{ $cabinets->email }}
                                </h5>
                            </div>
                        ...
                        <div class="col-span-2 sm:col-span-1 p-4">
                            <div class="form-group">
                                <x-input-label for="timerecorded" :value="__('Date Time Created')" />
                                <h5 class="text-lg font-semibold text-gray-900 dark:text-white">
                                    {{ $cabinets->timerecorded }}
                                </h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <a href="{{ route('managecabinet.cabinetlist',$cabinets->branchid) }}" class="py-2 px-3 ms-3 flex items-center text-sm font-medium text-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
