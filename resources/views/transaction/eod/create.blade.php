	...
	<div class="max-w-screen-2xl mx-auto sm:px-6 lg:px-8">
		<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
			<div class="py-8">
				<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
					<div class="max-w-screen-2xl mx-auto sm:px-6 lg:px-8">
                        <form action="{{ route('transactioneod.store') }}" enctype="multipart/form-data" method="POST" class="p-4 md:p-5">
                            @csrf
                                ...
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2 sm:col-span-1">
                                        ...
                                        <div class="col-span-2 sm:col-span-1">
                                                ...
                                                <x-text-input id="rpamount" class="block mt-1 w-full" type="text" name="rpamount" :value="old('rpamount')" required autofocus autocomplete="off" />
...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <a href="{{ route('rentalpayments.index') }}"> Rental Payments</a> / <u>{{ __('Create New Rental Payment') }}</u>
        </h2>
    </x-slot>
    <section>
        <div class="py-8">
