                        ...
                        <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                            <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                                <x-primary-button class="ms-4">
                                    <a class="btn btn-primary" href="{{ route('transactionrental.selectrenter') }}"> Create New Rental Payments</a>
                                </x-primary-button>
                                <x-primary-button class="ms-4">
                                <a class="btn btn-primary" href="{{ route('transactionrental.setpayment') }}">Set Month</a>
                                </x-primary-button>
