            ...
            <div class="py-8 max-w-screen-2xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="relative bg-white rounded-lg dark:bg-gray-800">
                    ...
                    <div class="flex items-center justify-between p-4 md:p-5 rounded-t dark:border-gray-600">
                        <img class="h-auto max-w-lg rounded-lg" src="{{ asset("/storage/$sales->salesavatar") }}" alt="sales avatar" />
                    </div>

                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2 sm:col-span-1 p-4">
                            <div class="form-group">
                                <x-input-label for="branchname" :value="__('Cabinet No.')" />
                        ...
                        <div class="col-span-2 sm:col-span-1 p-4">
                            <div class="form-group">
                                <x-input-label for="branchaddress" :value="__('Product Name')" />
                                <h5 class="text-lg font-semibold text-gray-900 dark:text-white">
                                    {{ $sales->productname }}
                                </h5>
                            </div>
                        ...
                        <div class="col-span-2 sm:col-span-1 p-4">
                            <div class="form-group">
                                <x-input-label for="branchcontact" :value="__('Qty')" />
                                <h5 class="text-lg font-semibold text-gray-900 dark:text-white">
                                    {{ $sales->qty }}
                                </h5>
                            </div>
                        ...
                        <div class="col-span-2 sm:col-span-1 p-4">
                            <div class="form-group">
                                <x-input-label for="branchemail" :value="__('Price')" />
                                <h5 class="text-lg font-semibold text-gray-900 dark:text-white">
                                    {{ $sales->srp }}
                                </h5>
                            </div>
                        ...
                        <div class="col-span-2 sm:col-span-1 p-4">
                            <div class="form-group">
                                <x-input-label for="cabinetcount" :value="__('Sold By')" />
                                <h5 class="text-lg font-semibold text-gray-900 dark:text-white">
                                    {{ $sales->created_by }}
                                </h5>
                            </div>
                        ...
                        <div class="col-span-2 sm:col-span-1 p-4">
                            <div class="form-group">
                                <x-input-label for="cabinetcount" :value="__('Date Time Created')" />
                                <h5 class="text-lg font-semibold text-gray-900 dark:text-white">
                                    {{ $sales->created_at }}
                                </h5>
                            </div>
                    ...
                    <div class="flex items-center justify-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <a href="{{ route('reportssales.index') }}" class="py-2 px-3 ms-3 flex items-center text-sm font-medium text-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
