					...
					<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
						 ...
						 <nav class="flex px-5 py-3 text-gray-700  bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <a href="{{ route('reportssales.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
						...
						<div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
							<form class="flex items-center" action="{{ route('reportssales.search') }}" method="get">
								@csrf
