...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <a href="{{ route('rentercashierrental.index') }}"> Rental Payments</a>/ {{ __('Payment Information') }} / <u>{{ $rentername }}</u>
        </h2>
    </x-slot>
    <section>
        <div class="py-8">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <form action="{{ route('rentercashierrental.store') }}" method="POST" class="p-4 md:p-5">
                        @csrf   
                                    ...
                                    <div class="grid gap-4 mb-4 grid-cols-2" x-data="{ rent: '{{ $cabinet->cabinetprice }}', rentpay: 0,  bal: 0}" x-effect="bal = rent - rentpay">
                                            ...
                                            <div class="col-span-2 sm:col-span-1">
                                                ...
                                                <div class="form-group mt-4">
                                                    ...
                                                    <x-text-input id="firstname" class="block mt-1 w-full" type="text" name="firstname" value="{{ $renters->lastname.', '.$renters->firstname }}" required autofocus readonly/>
                                            ...
                                            <!-- avatar -->
                                            <div class="form-group mt-4">
                                                <x-input-label for="name" value="Payment Proof" />
                                                <x-text-input id="payavatar" name="payavatar" type="file"  class="mt-1 block w-full mt-1" :value="old('payavatar')" autofocus autocomplete="off" required/>
                                            ...
                                            <div class="col-span-2 sm:col-span-1 ">
                                                <!-- rpnotes -->
                                                <div class="form-group mt-4">
                                                    <x-input-label for="rpnotes" :value="__('Amount to be Paid')" />
                                            ...
                                            <div class="col-span-2 sm:col-span-1 ">
                                                <!-- rpnotes -->
                                                <div class="form-group mt-4">
                                                    <x-input-label for="rpnotes" :value="__('Total Balance')" />
