                        ...
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            <div class="relative bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                                ...
                                <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                                    ...
                                    <form class="flex items-center" action="{{ route('renters.search') }}" method="get">
                                            ...
                                            <tbody>
                                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                    ...
                                                    <td class="px-6 py-4">
                                                        ...
                                                        @endphp
                                                        <form action="{{ route('renters.destroy',$renters->rentersid) }}" method="POST">
                                                            <a class="font-medium text-white-600 dark:text-white-500 hover:underline" href="{{ route('renters.show',$renters->rentersid) }}">Cabinets</a>
                                                            | <a class="font-medium text-blue-600 dark:text-blue-500 hover:underline" href="{{ route('renters.edit',$renters->rentersid) }}">Modify</a>
                                                            @csrf
                                                            @method('DELETE')
                                                            @php
                                                            $txtbutton = '';
